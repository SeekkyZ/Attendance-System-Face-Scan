...
class FaceRecognitionController extends Controller
{
    ...
    public function scanFace(Request $request)
    {
        ...
        try {
            ...
            $attendance = Attendance::create([
                ...
                'session' => $session,
                'type' => $request->type,
                'attendance_time' => Carbon::now('Asia/Bangkok'),
    ...
    public function getLocations()
    {
        $locations = Auth::user()->locations()
                        ...
                        ->select('locations.id', 'locations.name', 'locations.description', 'locations.latitude', 'locations.longitude', 'locations.radius')
                        ->get();
